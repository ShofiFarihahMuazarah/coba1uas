document.getElementById("Jumlah").onclick = function() {TampilkanNilai()};
function TampilkanNilai() {
  ...
  return alert(`Anda Maju Sebanyak ${total} Langkah`)
}

document.getElementById("bt1").onclick = function() {Acak1()};
function Acak1() {
  var Dadu1 = Math.floor(Math.random() * (7 - 1) ) + 1;
  document.getElementById("Nilai1").innerHTML = Dadu1;
  document.getElementById("Dadu1").src = "dice"+Dadu1+".png"
}

document.getElementById("bt2").onclick = function() {Acak2()};
function Acak2() {
  var Dadu2 = Math.floor(Math.random() * (7 - 1) ) + 1;
  document.getElementById("Nilai2").innerHTML = Dadu2;
  document.getElementById("Dadu2").src = "dice"+Dadu2+".png"
}
